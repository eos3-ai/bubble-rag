...
MYSQL_URL = os.environ.get("MYSQL_URL", "mysql+pymysql://root:admin@127.0.0.1:23306/laiye_rag_community?charset=utf8")

MILVUS_SERVER_IP = os.getenv('MILVUS_SERVER_IP', '127.0.0.1')
...
## mineru服务器地址
MINERU_SERVER_URL = os.getenv("MINERU_SERVER_URL", "http://127.0.0.1:28100")

## 多模型配置
VLM_BASE_URL = os.getenv("VLM_BASE_URL", "http://127.0.0.1:30010/v1/")
VLM_API_KEY = os.getenv("VLM_API_KEY", "1111")
VLM_MODEL_NAME = os.getenv("VLM_MODEL_NAME", "qwen2.5-vl-instruct")

## 聊天模型配置
LLM_BASE_URL = os.getenv("LLM_BASE_URL", "http://127.0.0.1:26014/v1/")
LLM_API_KEY = os.getenv("LLM_API_KEY", "111")
LLM_MODEL_NAME = os.getenv("LLM_MODEL_NAME", "Qwen3-235B-A22B")

## 当前服务器ip
CURR_SERVER_IP = os.getenv("CURR_SERVER_IP", "127.0.0.1")
