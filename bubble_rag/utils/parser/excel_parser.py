...
class RAGFlowExcelParser:
    ...
    def _load_excel_to_workbook(file_like_object):
        ...
        if not (file_head.startswith(b'PK/x03/x04') or file_head.startswith(b'PK\x03\x04') or file_head.startswith(b'/xD0/xCF/x11/xE0')):
    ...
    def row_number(fnm, binary):
        ...
        if fnm.split(".")[-1].lower() in ["csv", "txt"]:
            ...
            return len(txt.split("/n"))


if __name__ == "__main__":
    psr = RAGFlowExcelParser()
    with open(r"/mnt/d/Xerecter/Project/Laiye/data_extract/code/data_files/250416/惠中动保疫苗、化药、驱虫产品基本信息.xlsx", 'br', ) as f:
        psr(f.read())
